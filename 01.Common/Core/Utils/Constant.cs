...
namespace Core.Utils
{
    public class Constant
    {
        ...
        public class ErrorCode
        {
            ...
            public const string FAIL_EXISTED_MESS_HISTORY = "Quá trình công tác trong khoảng thời gian này đã tồn tại";

            /// <summary>
            /// Quá trình lương
            /// </summary>
            public const string DUPLICATE_STAFF_SALARY = "Quá trình lương trong khoảng thời gian này đã tồn tại hoặc Loại nâng lương này đã được tạo cho quá trình lương trước đó";
