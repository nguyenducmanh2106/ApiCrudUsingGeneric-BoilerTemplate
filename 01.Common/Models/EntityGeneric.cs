...
namespace Models
{
    public class EntityGeneric<T>
    {
        ...
        {
            IsGetCache = false;
            //LayoutCode = typeof(T).Name.ToString();
        }
        ...
        public string TitleColumnDynamics { get; set; }
        public string ParamColumnDynamics { get; set; }

    }

    //public class EntityGenericExport<T> : EntityGeneric<T>
    //{
    //    public List<TableFieldExportExcel> ColumnExports { get; set; }
    //}
