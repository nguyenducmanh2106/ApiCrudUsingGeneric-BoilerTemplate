...
namespace Models
{
    ...
    public class WorkGroupBaseModel
    {
        public int WorkGroupID { get; set; }
        public string WorkGroupCode { get; set; }
    }

    public class WorkGroupModel : WorkGroupBaseModel
    {
        public int? ParentWorkGroupID { get; set; }
        public string WorkGroupName { get; set; }
        public string WorkGroupName1 { get; set; }
        ...
        public string WorkGroupName_Vi { get; set; }
    }

    public class WorkGroupComboboxModel : WorkGroupBaseModel
    {
        public string WorkGroupName { get; set; }
    }

    public class WorkGroupCreateModel : WorkGroupModel
    {
